...
alias wkgpanr='viddy -n 2 "kubecolor --force-colors get pods --all-namespaces --field-selector=status.phase!=Running,status.phase!=Completed"'
alias kgpw='viddy -n 2 "kubecolor --force-colors get pods"'
alias kgpow='kgp -o wide'
alias wkgpow='viddy -n 2 "kubecolor --force-colors get po -o wide"'
alias kgpoy='kgp -o yaml'
alias wkgpa='viddy -n 2 "kubecolor --force-colors get pods --all-namespaces"'
alias wkgp='viddy -n 2 "kubecolor --force-colors get po"'
...
alias kgsw='viddy -n 2 "kubecolor --force-colors get svc"'
...
alias kgdw='viddy -n 2 "kubecolor --force-colors get deployment"'
...
alias kgssw='viddy -n 2 "kubecolor --force-colors get statefulset"'
...
alias kgpvcw='viddy -n 2 "kubecolor --force-colors get pvc"'
...
alias kgdsw='viddy -n 2 "kubecolor --force-colors get daemonset"'
